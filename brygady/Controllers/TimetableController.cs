...
public async Task<ActionResult> SaveTimetable([FromBody] List<JsonElement> timetableData)
{
    ...
    try
    {
        ...
        using (var checkCommand = new NpgsqlCommand(checkTripsQuery, connection, transaction))
        {
            ...
            // Dodawanie nowych tripów do bazy, jeśli nie istnieją
        ...
        // Przygotowanie zapytania do wstawiania/aktualizacji danych w tabeli trip_times
        var insertTimeQuery = @"
        ...
        // Kolekcja parametrów do zapytania
        ...
        // Wykonanie zapytania dla wszystkich wpisów
